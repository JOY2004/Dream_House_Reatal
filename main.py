...
image = PhotoImage(file="dream.png")
resized_image = image.subsample(4)
image_label = Label(root, image=resized_image)
image_label.place(x=265, y=15)


staff_label=Label(root, text="Staff ", bg="#030001", fg="#FFFFFF",font=("Arial", 14)).place(x=50, y=170)
client_label=Label(root, text="Client", bg="#030001", fg="#FFFFFF",font=("Arial", 14)).place(x=270, y=170)
owner_label=Label(root, text="Owner ", bg="#030001", fg="#FFFFFF",font=("Arial", 14)).place(x=490, y=170)

client_registration = tk.Button(root, text="Client Registration",
                             bg="#030001", fg="white", height="2", width=19,font=("Arial", 12), command=redirect_client_registration).place(x=270, y=210)

view_listed_properties = tk.Button(root, text="View Listed Properties",
                                bg="#030001", fg="white", height="2", width=19,font=("Arial", 12), command=redirect_view_listed_properties).place(x=270, y=280)

provide_comments = tk.Button(root, text="Provide Comments", bg="#030001",
                          fg="white", height="2", width=19,font=("Arial", 12), command=redirect_provide_comments).place(x=270, y=350)

staff_onboarding = tk.Button(root, text="Staff Onboarding", bg="#030001",
                          fg="white", height="2", width=19,font=("Arial", 12), command=redirect_staff_onboarding).place(x=50, y=210)

View_staff = tk.Button(root, text="View Staff", bg="#030001",
                          fg="white", height="2", width=19,font=("Arial", 12), command=view_staff).place(x=50, y=280)

lease_form =tk.Button(root, text="Lease Form", bg="#030001",
...
property_registration = tk.Button(root, text="Property Registration",
                               bg="#030001", fg="white", height="2", width=19,font=("Arial", 12), command=redirect_property_registration).place(x=490, y=210)

View_client = tk.Button(root, text="View Client", bg="#030001",
